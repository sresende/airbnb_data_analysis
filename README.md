...
Several supervised and unsupervised machine learning models were developed and implemented and then evaluated considering scoring and MSE (mean error sum) metrics.
